<?php
/**
 * CMIS Repository Document Object Property Collection API class for KnowledgeTree.
 *
...
require_once(CMIS_DIR . '/classes/CMISPropertyCollection.inc.php');

/**
 * This class contains the document object properties
 */
