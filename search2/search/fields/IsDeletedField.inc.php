...
class IsDeletedField extends DBFieldExpr
{
    public function __construct()
    {
        parent::__construct('status_id', 'documents', _kt('Is Deleted'));
        $this->setAlias('IsDeleted');
        $this->isValueQuoted(false);
    }

	public function modifyValue($value)
    {
    	$value = KTUtil::anyToBool($value, false)?3:1;
    	return $value;
    }
