...
ALTER TABLE `workflow_transitions` ADD COLUMN `guard_condition_id` int(11) default NULL;
ALTER TABLE `workflow_transitions` ADD INDEX `guard_condition` (`guard_condition_id`);
