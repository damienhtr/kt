...
class stepAction {
	...
	* @return string
	*/
    public function setUpStepAction($steps, $stepNames, $stepConfirmation, $stepDisplayFirst, $session, $migrateProperties) {
        $this->setSteps($steps);
	...
	*/
	...
	public function getVars() {
		...
		$vars['migrate_version'] = $this->migrateProperties['migrate_version']; // Set version
		$vars['migrate_type'] = $this->migrateProperties['migrate_type']; // Set type
		return $vars;
	}
    /**
