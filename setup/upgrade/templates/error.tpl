	...
	<body onload="">
		<div id="outer-wrapper">
		    ...
		    <div id="install_details">
				<span style="font-size:120%;"> <?php echo $upgrade_version; ?> </span>
		    ...
		    <div id="wrapper">
		        <div id="container">
		        	<div id="sidebar">
                        ...
                        <span class="inactive">Current Installation</span><br>
                        <span class="inactive">Database Upgrade</span><br>
                        <span class="inactive">Complete</span><br></div>

		            <div id="content">
		            	<div id="content_container">
		                	<form action="index.php?step_name=welcome" method="post">
		                		<div id="step_content" class="step">
					                <p class="title">Welcome to the KnowledgeTree Upgrade Wizard</p>
									<?php if(isset($error)) {
